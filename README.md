...
Bpay是一个集成了支付宝和微信支付监控的综合解决方案，完全、完全、完全无需任何资质的轻量化系统
...
- 解决个人资质限制问题，支持个人用户接入支付宝和微信支付，无需任何资质认证
- 提供多种支付方式支持
- 实现自动监控和通知
- 微信OCR识别几乎无任何封号风险
...
3. **配置支付宝（当面付，如无资质请配置python脚本）**：
   - 登录管理后台：`http://yourdomain/admin/login`
   - 进入「支付宝配置」页面
...
- **管理后台地址**：`http://yourdomain/admin/login`
- **默认密码**：admin123
...
<p align="center">
  <img src="./assets/赞赏码.jpg" alt="赞赏码" width="300"/>
</p>

### 源码下载

- **GitHub**：直接克隆本仓库
- **夸克网盘**：[点击下载](https://pan.quark.cn/s/cf9ba041be13)（从网盘下载也能支持我们，感谢！）
